...
\end{tabular}
\caption{Super-resolution results of ``img082"(\textit{Urban100}) with scale factor $\times$4. Lines is straightened and sharpened in our result, whereas other methods give blurry lines. Our result seems visually pleasing.}
\label{fig:img1}
\end{center}
\end{adjustwidth}
\end{figure*}
