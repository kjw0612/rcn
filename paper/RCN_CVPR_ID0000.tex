...
& \raisebox{-13.0ex} {\graphicspath{{figs/fig1/}}\includegraphics[width=0.2\textwidth]{img053_for_fig1_RCN.png}}\vspace{0.3ex}
\\
...
& {\graphicspath{{figs/fig2/}}\includegraphics[width=0.15\textwidth]{img058_for_fig2_RCN.png}}
\\
