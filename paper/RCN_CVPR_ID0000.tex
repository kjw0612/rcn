...
\hline
\end{tabular}
\caption{Average PSNR/SSIM for scale factor$\times$4, $\times$4$\times$4 and  for Set5, Set14, B100 and Urban100. {\color{red}Red color} indicates the best performance and {\color{blue}blue color} indicates the second best one.}
\end{center}
\end{table*}
