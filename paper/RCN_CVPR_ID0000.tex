...
\begin{figure*}[t]
	...
	\caption {Architecture of our basic model. It consists of three parts: embedding network, inference network and reconstruction network. Inference network has a recursive layer and its unfolded version is in Figure \ref }
	\label{fig:overview}
\end{figure*}
...
As illustrated in Figure \ref{fig: TODO}, the inference network now learns a mapping to very sparse predictions and the required capacity to solve the task gets significantly reduced. 
